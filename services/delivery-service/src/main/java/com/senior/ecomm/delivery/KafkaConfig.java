...
class KafkaConfig {
  @Bean
  ConcurrentKafkaListenerContainerFactory<String, ShipmentPreparedEvent> shipmentPreparedListenerFactory(
    ...
    var json = new JsonDeserializer<>(ShipmentPreparedEvent.class);
    json.addTrustedPackages("com.senior.ecomm.*");
    var cf = new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), json);

    var factory = new ConcurrentKafkaListenerContainerFactory<String, ShipmentPreparedEvent>();
